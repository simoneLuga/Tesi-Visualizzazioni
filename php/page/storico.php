<div class="container">
    <div class="row">
        <div class="col-md-6 tipoSezione3">
            <div class="wrapperVisualizzaTestStorico">
                <button type="button" class="btn btn-secondary col-12" onclick="showCreaTest()">Crea nuovo test
                </button>
                <?php foreach ($templateParams["tests"] as $test): ?>
                    <div class="item row m-1" id="<?php echo $test['ID'] ?>" style="height: 37px;"
                        ...
                        <span class="col-6 p-1" style=" text-align: center;">
                            <?php echo $test['Nome'] ?>
                        </span>
                        <div class="btn-group col-6 " role="group" aria-label="Basic example">
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="modalDelete<?php echo $test['ID'] ?>" tabindex="-1"
                            ...
                            <button type="button" class="btn btn-sm <?php if ($test['attivo']) {
                                echo 'btn-success';
                            } else {
                                echo 'btn-danger';
